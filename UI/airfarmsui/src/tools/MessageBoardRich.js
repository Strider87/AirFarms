    ...
    const onSubmit = async (values, onSubmitProps) => {
        ...
        authProvider.authPost(`http://127.0.0.1:8000/activity/comment/new/`, comment, config, false)
          .then(res => {
            ...
            {
                const comment_pic_id = {
                    comment: image.images[i].comment_pic_id
                }
                authProvider.authPatch(`http://127.0.0.1:8000/activity/comments/picture/handle/`, comment_pic_id, config)
                .then(res =>{
                    console.log(res);
                    console.log(res.data);
                })
        ...
        return (        
            ...
            return (
                    ...
                    <Form>
                        ...
                        <br/>
                        <CustomFormikRichText name="message" />
                        <br/>
                        <HStack>
                            <Button 
                                type='submit' 
